  ...
  if (!document.getElementById("automation-story-upgrade-final")) {
    ...
    style.textContent = \`
      ...
      .automation-story-upgraded::before {
        ...
        border-radius: 22px;
        background: radial-gradient(circle at 78% 12%, rgba(47, 212, 199, 0.14), transparent 25rem), linear-gradient(135deg, rgba(255, 255, 255, 0.82), rgba(247, 250, 248, 0.92));
      ...
      .automation-story-upgraded .automation-narrative .section-intro h2 { max-width: 9ch; letter-spacing: -0.04em; }
      ...
      .automation-cta-row { display: flex; flex-wrap: wrap; gap: 0.7rem; margin-top: 1.4rem; }
      ...
      .automation-story-upgraded .automation-cta-row .button.secondary { color: var(--ink-950); background: #fff; border-color: rgba(18, 42, 61, 0.16); }

      .automation-story-upgraded .automation-scroll-steps { border-top: 0; gap: 0.7rem; }
      .automation-story-upgraded .automation-step {
        ...
        transition: transform var(--motion-fast) var(--ease-feedback), border-color var(--motion-fast) var(--ease-standard), background-color var(--motion-fast) var(--ease-standard), box-shadow var(--motion-fast) var(--ease-standard);
      }
      ...
      .automation-story-upgraded .automation-workflow-panel {
        ...
        background: radial-gradient(circle at 78% 12%, rgba(47, 212, 199, 0.2), transparent 19rem), linear-gradient(160deg, rgba(12, 28, 43, 0.98), rgba(7, 19, 31, 1));
        box-shadow: 0 28px 90px rgba(7, 19, 31, 0.26);
      }

      .automation-panel-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 1rem; padding: 0.2rem 0.15rem 0.75rem; border-bottom: 1px solid rgba(220, 229, 236, 0.12); }
      .automation-panel-head small,
      .automation-live-readout span { color: rgba(247, 249, 252, 0.58); font-family: var(--font-mono); font-size: 0.72rem; font-weight: 760; text-transform: uppercase; letter-spacing: 0.05em; }
      .automation-panel-head strong { display: block; color: #fff; font-size: 1.04rem; }
      .automation-panel-status { display: inline-flex; align-items: center; gap: 0.45rem; color: rgba(247, 249, 252, 0.72); font-size: 0.78rem; font-weight: 820; }
      .automation-panel-status::before { content: ""; width: 0.55rem; height: 0.55rem; border-radius: 50%; background: var(--signal-cyan); box-shadow: 0 0 0 5px rgba(47, 212, 199, 0.11), 0 0 24px rgba(47, 212, 199, 0.56); }

      .automation-story-upgraded .automation-workflow {
        min-height: 455px;
        border-radius: 16px;
        background: linear-gradient(rgba(247, 249, 252, 0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(247, 249, 252, 0.04) 1px, transparent 1px), radial-gradient(circle at 50% 50%, rgba(47, 212, 199, 0.08), transparent 18rem);
      ...
      .automation-story-upgraded .automation-flow-track { fill: none; stroke: rgba(220, 229, 236, 0.24); stroke-width: 2; }
      .automation-story-upgraded .automation-flow-active { fill: none; stroke: var(--signal-cyan); stroke-width: 3; stroke-linecap: round; stroke-dasharray: 1; stroke-dashoffset: 1; filter: drop-shadow(0 0 10px rgba(47, 212, 199, 0.72)); animation: automationPathTravelSegmented 11s linear infinite; }
      ...
      .automation-story-upgraded .automation-node small { color: rgba(247, 249, 252, 0.54); font-family: var(--font-mono); font-size: 0.68rem; font-weight: 760; text-transform: uppercase; }
      .automation-story-upgraded .automation-node.is-active { box-shadow: 0 0 0 1px rgba(47, 212, 199, 0.2), 0 18px 44px rgba(0, 0, 0, 0.28); }

      .automation-live-readout { position: absolute; left: 0.9rem; right: 0.9rem; bottom: 0.9rem; display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0.55rem; }
      .automation-live-readout span { display: grid; gap: 0.3rem; padding: 0.6rem; border: 1px solid rgba(220, 229, 236, 0.12); border-radius: 12px; background: rgba(255, 255, 255, 0.04); }
      .automation-live-readout span::before { content: ""; width: 100%; height: 2px; border-radius: 999px; background: linear-gradient(90deg, var(--signal-cyan), transparent); opacity: 0.72; }

      .automation-story-upgraded .automation-final-state { border-radius: 14px; border-color: rgba(47, 212, 199, 0.3); background: linear-gradient(90deg, rgba(47, 212, 199, 0.12), rgba(47, 212, 199, 0.04)); }
      .automation-story-upgraded .automation-final-state p { color: rgba(247, 249, 252, 0.76); font-weight: 760; }

      @keyframes automationPathTravelSegmented {
        0% { stroke-dashoffset: 1; opacity: .52; }
        18.18% { stroke-dashoffset: .75; opacity: .86; }
        45.45% { stroke-dashoffset: .50; opacity: 1; }
        63.64% { stroke-dashoffset: .25; opacity: 1; }
        81.82% { stroke-dashoffset: 0; opacity: .92; }
      ...
      @media (max-width: 680px) {
        ...
        .automation-story-upgraded .automation-workflow { min-height: auto; display: grid; gap: 0.72rem; padding: 0.82rem; }
        .automation-story-upgraded .automation-flow-line,
        .automation-story-upgraded .automation-data-lines { display: none; }
        .automation-story-upgraded .automation-node { position: relative; inset: auto; width: 100%; min-height: 0; opacity: 0.86; }
        .automation-story-upgraded .automation-node::before { left: -0.34rem !important; right: auto !important; top: calc(50% - 0.33rem) !important; }
      ...
      @media (prefers-reduced-motion: reduce) {
        .automation-story-upgraded *, .automation-story-upgraded *::before, .automation-story-upgraded *::after { animation-duration: 0.001ms !important; animation-iteration-count: 1 !important; scroll-behavior: auto !important; transition-duration: 0.001ms !important; }
